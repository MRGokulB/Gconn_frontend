...
const About = () => {
  ...
  const philosophyText = `The Nursing Programme would strive to achieve academic and health excellence by educating and training the students who shall function as nurse specialists, practioners, consultants, educators, administrators and researchers in a wide variety of professional settings in meeting the National Health Priorities and changing health needs of the society. It would encourage being self directed and effectively dealing with day to day health problems within the existing constraints and acting as an agent of social change. It would prepare a nurse who can make independent decision in nursing situations, protect the rights of patients and facilitate individuals and groups in pursuit of health care in the hospital, community and conduct research studies in the area of nursing practice.It would promote accountability and commitment to the nursing profession and encourage lifelong learning which fosters quality nursing care.`;
  ...
  return (
    <section className="bg-white py-16 px-6 md:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        <h3 className="text-lg md:text-xl font-semibold text-gray-700 mb-6 uppercase tracking-wide">
